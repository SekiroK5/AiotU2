...
# Configuración del sensor MQ-5
sensor_digital = Pin(17, Pin.IN)  # Salida digital del MQ-5 (0 = gas detectado, 1 = sin gas)
sensor_analogico = ADC(Pin(35))   # Salida analógica del MQ-5 (concentración de gas)
...
while True:
    try:
        ...
        mensaje_estado = "⚠️ Gas detectado" if estado == 0 else "✅ Aire limpio"
