...
sensor_digital = Pin(17, Pin.IN)  # Salida digital del MQ-9 (0 = gas detectado, 1 = sin gas)
sensor_analogico = ADC(Pin(35))   # Salida analógica del MQ-9 (concentración de gas)
