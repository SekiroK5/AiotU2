...
sensor_pin = Pin(17, Pin.IN)  # Pin donde conectaste el sensor
...
# Configuración MQTT
MQTT_CLIENT_ID = "esp32_ky021_magnetico"
MQTT_BROKER = "172.20.10.2"  # Cambia a la IP de tu broker MQTT
MQTT_PORT = 1883
MQTT_TOPIC_PUB = "ncm/sensor"  # Topic para enviar el estado del sensor
...
# Bucle principal para leer el sensor KY-021
while True:
    try:
